...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="bg-gradient-to-br from-white/95 to-gray-50/90 backdrop-blur-[60px] backdrop-saturate-[200%] rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.8)] p-5 sm:p-8 border border-gray-200/60">
          {/* Logo */}
          <motion.div
          ...
          >
            ...
            <p className="text-gray-600 mt-2 text-sm">创建您的账号</p>
          </motion.div>
          ...
          >
            <p className="text-sm text-gray-700">
              已有账号？{' '}
              <Link href="/login" className="text-blue-600 hover:text-blue-700 font-medium transition-colors underline decoration-transparent hover:decoration-blue-600">
                立即登录
              </Link>
            </p>
          </motion.div>
